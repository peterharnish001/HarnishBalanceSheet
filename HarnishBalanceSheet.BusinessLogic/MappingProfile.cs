...
namespace HarnishBalanceSheet.BusinessLogic
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Coins, BullionDto>();
            CreateMap<IEnumerable<Coins>, IEnumerable<BullionDto>>();
            ...
            CreateMap<BalanceSheet, DetailsDto>()
                ...
                .ForMember(dest => dest.Bullion, opt => opt.MapFrom(src => src.Coins));
            ...
            CreateMap<DetailsDto, Details>()
                ...
                .ForMember(dest => dest.BalanceSheet.Coins, opt => opt.MapFrom(src => src.Bullion))
            ...
            CreateMap<BullionDto, Coins>();
            CreateMap<IEnumerable<BullionDto>, IEnumerable<Coins>>();
            CreateMap<BalanceSheetEditDto, BalanceSheet>()
                .ForMember(dest => dest.Assets, opt => opt.MapFrom(src => src.Assets))
                .ForMember(dest => dest.Liabilities, opt => opt.MapFrom(src => src.Liabilities))
                .ForMember(dest => dest.Coins, opt => opt.MapFrom(src => src.Bullion));
        }
    }
}
